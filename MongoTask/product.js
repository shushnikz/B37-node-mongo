...
db.product.find({product_price: {$gt: 400.00,$lt:800.00}}).pretty()

// 3.Find the product price which are not between 400 to 600
db.product.find({product_price: {$lt: 400,$gt: 600}}).pretty()
...
db.product.find({product_color: {$eq: "indigo"},product_price: {$eq: 492.00}}).pretty()
